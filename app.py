...
# ENFORCE------------------------------------------------------------------------------------------
    ...
    # --- New: remember acceptance and hide Terms when accepted ---
    if 'accepted_terms' not in st.session_state:
        st.session_state['accepted_terms' = False

    if not st.session_state['accepted_terms']:
        with st.expander("Terms of Use & Privacy Notice (click to expand)", expanded=True):
            st.markdown("""
            ...
            """)
            accepted = st.checkbox("I have read and accept the Terms of Use & Privacy Notice.", value=False)
            if accepted:
                st.session_state['accepted_terms'] = True
                st.success("Terms accepted. Proceed with analysis below.")
                st.rerun()
    # --- End new block ---

    # When accepted, show the analysis UI
        # )
        #add tickbox to accept terms
